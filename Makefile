...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sat Oct 22 14:39:14 2016
# Project:  Tetris.pro
# Template: app
# Command: /usr/local/software/qt4/bin/qmake -o Makefile Tetris.pro
#############################################################################
...
SOURCES       = BlackBox.cpp \
		...
		GameBoard.cpp \
		main.cpp \
		preview.cpp moc_DisplayZone.cpp \
		moc_GameBoard.cpp
OBJECTS       = BlackBox.o \
		Blocks.o \
		DisplayZone.o \
...
Makefile: Tetris.pro  /usr/local/software/qt-4.8.6/mkspecs/linux-g++-64/qmake.conf /usr/local/software/qt-4.8.6/mkspecs/common/unix.conf \
		/usr/local/software/qt-4.8.6/mkspecs/common/linux.conf \
		/usr/local/software/qt-4.8.6/mkspecs/common/gcc-base.conf \
		/usr/local/software/qt-4.8.6/mkspecs/common/gcc-base-unix.conf \
		/usr/local/software/qt-4.8.6/mkspecs/common/g++-base.conf \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/Tetris1.0.0 || $(MKDIR) .tmp/Tetris1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Tetris1.0.0/ && $(COPY_FILE) --parents BlackBox.h block.h DisplayZone.h GameBoard.h preview.h .tmp/Tetris1.0.0/ && $(COPY_FILE) --parents BlackBox.cpp Blocks.cpp DisplayZone.cpp GameBoard.cpp main.cpp preview.cpp .tmp/Tetris1.0.0/ && (cd `dirname .tmp/Tetris1.0.0` && $(TAR) Tetris1.0.0.tar Tetris1.0.0 && $(COMPRESS) Tetris1.0.0.tar) && $(MOVE) `dirname .tmp/Tetris1.0.0`/Tetris1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Tetris1.0.0
...
compiler_moc_header_make_all: moc_DisplayZone.cpp moc_GameBoard.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_DisplayZone.cpp moc_GameBoard.cpp
moc_DisplayZone.cpp: DisplayZone.h
	/usr/local/software/qt-4.8.6/bin/moc $(DEFINES) $(INCPATH) DisplayZone.h -o moc_DisplayZone.cpp

moc_GameBoard.cpp: BlackBox.h \
		block.h \
		preview.h \
		DisplayZone.h \
		GameBoard.h
	/usr/local/software/qt-4.8.6/bin/moc $(DEFINES) $(INCPATH) GameBoard.h -o moc_GameBoard.cpp
...
BlackBox.o: BlackBox.cpp BlackBox.h \
		block.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o BlackBox.o BlackBox.cpp

Blocks.o: Blocks.cpp BlackBox.h \
		block.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Blocks.o Blocks.cpp

DisplayZone.o: DisplayZone.cpp DisplayZone.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o DisplayZone.o DisplayZone.cpp
...
moc_DisplayZone.o: moc_DisplayZone.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_DisplayZone.o moc_DisplayZone.cpp
